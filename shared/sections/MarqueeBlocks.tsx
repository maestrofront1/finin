        ...
        <div ref={overlayRef} style={{ position: "fixed", left: 0, top: 0, zIndex: 9999, pointerEvents: "none" }}>
            ...
            >
                <div className="w-[520px] bg-white rounded-2xl shadow-lg p-5">
                    ...
                    <div className="flex justify-end"><Button variant="gray" withArrow={false}>Подробнее</Button></div>
                </div>
            </div>
        </div>,
        document.body
                        ...
                        return (
                            ...
                            >
                                <div className="px-5 py-4 max-md:px-2">
                                    <div className="flex items-center gap-[40px] text-[68px] text-gray-300 font-regular mb-3 max-md:text-[22px]">
                                        {it.title}
                                        <svg width="25" className="max-md:w-[14px] max-md:h-[14px]" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M24.2598 22.7998C24.2598 23.6282 23.5882 24.2998 22.7598 24.2998C21.9313 24.2998 21.2598 23.6282 21.2598 22.7998V5.9209L2.88086 24.2998C2.29514 24.8855 1.34549 24.8855 0.759766 24.2998C0.174042 23.7141 0.174042 22.7644 0.759766 22.1787L19.1387 3.7998H2.25977C1.43134 3.7998 0.759766 3.12823 0.759766 2.2998C0.759766 1.47138 1.43134 0.799805 2.25977 0.799805H22.7598L24.2598 2.2998V22.7998Z" fill="#A5ADBD" />
                                        </svg>
                                        /
                                    </div>
                                </div>
                ...
                {isMobile && openIndex !== null && (
                    ...
                    >
                        <div className="bg-white p-5 border-t border-gray-200">
                            <h3 className="text-xl font-semibold mb-2">{ITEMS[openIndex].title}</h3>
                            <p className="text-sm text-gray-600 mb-4">{ITEMS[openIndex].text}</p>
